...
var GetNetHandle = function (a) {
    return new Promise(function (b, c) {
      _1042 = new NetHandle(a)
      _1042.getToken().then(function (a) {
        b(a)
      })
    })
  },
...
function pageinit() {
  ...
  $('#property-plan-add-save').on('click', function (a) {
    ...
    _1042.saveSche(inp1.value, inp2.value).then(function (a) {
      1 === a && _1024._00C()
    })
  })
  // 相机书签
...
function init(a, b) {
  ...
  _1024 = new _0x3B2(camera, scene, _1042, b)
    ...
    c = new Promise(function (c, g) {
      0 == b.type
        ? (console.log('rvt model'),
          _1042.getModel(a).then(function (a) {
